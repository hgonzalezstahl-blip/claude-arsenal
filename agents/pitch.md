...
- Resume: `C:\Users\hgonz\Downloads\Resume, Cover Letters, Awards\Master Resume [Your Name] [Month YYYY].docx`
- Cover letter: any file in `C:\Users\hgonz\Downloads\Resume, Cover Letters, Awards\Cover Letter\` (use a recent one matching the JD's industry — JP Morgan Cover Letter for finance, Microsoft for tech, etc.)
...
- Standard fonts (the user's master uses Garamond — preserve it; do not substitute Calibri)
- Margins per the master file (the user's master is 0.30" — do not enlarge to default 0.7")
