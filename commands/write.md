---
description: Invoke Echo to write an assignment in Hector's voice (no AI tells)
allowed-tools: Agent, Read
---

Spawn the **echo** subagent to write the following assignment in Hector's voice. Echo must:
...
3. If the style profile has no samples, refuse to draft and ask Hector to add samples.
